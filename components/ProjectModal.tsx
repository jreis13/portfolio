...
export function ProjectModal({
  ...
  return (
    <div className="fixed inset-0 z-[9999]">
      ...
      >
        <div
          className="relative w-full max-w-5xl overflow-hidden rounded-3xl border border-slate-800 bg-slate-950 shadow-2xl"
            ...
            <div className="flex items-center gap-2">
              ...
              {project.link ? (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex rounded-full bg-sky-500 px-4 py-2 text-sm font-semibold text-slate-950 hover:bg-sky-400"
                >
                  Visit site
                </a>
              ) : null}
              ...
              <button
                type="button"
                onClick={onClose}
                className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-slate-700 bg-slate-900 text-slate-100 hover:border-sky-400/40 cursor-pointer"
